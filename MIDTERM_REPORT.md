...
The primary performance breakthrough is the **Adaptive Round Scaling** mechanism. By dropping from 12 rounds to the 8-round failsafe during congestion:
- **Observed Latency Reduction**: **~33% - 35%**.
